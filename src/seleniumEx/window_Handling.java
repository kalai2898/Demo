...
public class window_Handling {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		   System.setProperty("webdriver.chrome.driver", "D:\\java demo\\Selenium1\\driver\\chromedriver.exe");
		   ...
		   String handle = driver.getWindowHandle();
		    ...
		    WebElement path1 = driver.findElement(By.xpath("//a[contains(text(),' Electronics ')]"));
